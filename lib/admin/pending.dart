...
class datta {
  ...
  const datta(this.name1, this.lon, this.lat, this.state);
}

class pendHome extends StatefulWidget {
  const pendHome({super.key});

  @override
  State<pendHome> createState() => _pendHomeState();
}

class _pendHomeState extends State<pendHome> {
  String name = "";
